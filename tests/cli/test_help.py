...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["setup"], "Resolve or download a MegaDetector model for local inference."),
        ...
        (["detect", "content"], "Classify and move JPEGs as animal, human, vehicle, empty, or other."),
        ...
        (["pipeline", "run"], "Run eligible stages in order: corrupted, overexposed IR, bursts, then content detection."),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["detect", "content"], "Run model inference and report classifications without moving files or writing EXIF metadata."),
