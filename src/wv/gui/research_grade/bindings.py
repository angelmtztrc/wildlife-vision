...
from wv.gui.research_grade.controller import ResearchGradeController


def register_bindings(
    root,
    controller: ResearchGradeController,
    refresh: Callable[[], None],
    on_save: Callable[[], None],
    on_close: Callable[[], None],
) -> None:
    root.bind("f", lambda event: _run(controller.flag_current, refresh))
    root.bind("u", lambda event: _run(controller.unflag_current, refresh))
